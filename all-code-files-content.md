                        ...
                        <div class="project-tasks">
                            ...
                            <div class="task bg-{{ task.color }}"
                                ...
                                <div class="task-tooltip">
                                    <div class="dates">{{ task.dates }}</div>
                                    {% if task.comment %}
...
.task-tooltip {
    display: none;
    position: absolute; /* Revenir à absolute pour le positionnement relatif à la tâche */
    bottom: 100%; /* Positionner le bas du tooltip au niveau du haut de la tâche */
    left: 50%;
    transform: translateX(-50%);
    background-color: rgba(0, 0, 0, 0.9);
    color: white;
    padding: 8px; /* Réduire le padding global */
    border-radius: 0.25rem;
    font-size: 0.75rem;
    ...
    z-index: 1000;
    pointer-events: none;
    margin-bottom: 4px; /* Petit espace entre le tooltip et la tâche */
...
.task-tooltip .task-text {
    padding: 4px 0; /* Ajouter un peu d'espace vertical autour du texte */
    margin: 0;
    line-height: 1.2;
}
